...
dstatspark=$!
#dstat on Docker
docker container exec bigdata nohup dstat -m -c -d --output stat_docker_spark_$1_$2_$3_$4_$5.csv >> stat_output &
dstatspark_docker=$!
...
docker container exec bigdata nohup dstat -m -c -d --output stat_docker_hadoop_$1_$2_$3_$4_$5.csv >> stat_output &
dstathadoop_docker=$!
